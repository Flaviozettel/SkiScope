...
export const GEOSERVER_WFS =
  "http://192.168.4.228:8080/geoserver/skiscope/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=skiscope:skigebiet_geom&outputFormat=application/json";
